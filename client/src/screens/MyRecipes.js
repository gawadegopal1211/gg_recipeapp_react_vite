    ...
    const getRecipe = async () => {
        ...
        try {
            const res = await axios.get(
                `${import.meta.env.VITE_API_KEY}/recipes/recipe/${params.id}`
            );
        ...
        <div>
                ...
                <Box sx={{ mb: 6 }}>
                    {load ? (
                        ...
                        <Box sx={{ width: "100%", textAlign: "left" }}>
                            <Grid container spacing={4}>
                                <Grid size={{ lg: 6, md: 6, sm: 6, xs: 12 }}>
                                    <SubTitle variant="h5">{data.name}</SubTitle>
                                ...
                                <Grid size={{ lg: 6, md: 6, sm: 6, xs: 12 }}>
                                    <Heading variant="h6">Ingredients</Heading>
                                ...
                                <Grid size={{ lg: 12, md: 12, sm: 12, xs: 12 }}>
                                    <FlexStart>
                                        <Avatar
                                            sx={{ bgcolor: "#ab6b00", width: 24, height: 24, mr: 1 }}
                                        >
                                    ...
                                    <Heading variant="h6">Instructions</Heading>
            ...
            >
                ...
                <DialogActions sx={{ pr: 3 }}>
                    <Button3 onClick={() => handleClose()}>Close</Button3>

                    <Button1 onClick={() => UpdateRecipe()}>Save</Button1>
                </DialogActions>
            </Dialog>
